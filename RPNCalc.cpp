...
namespace L_VALUE_CALC
{
	...
	//	Description:	Constructor for CRPNCalc
	...
	//	Call:			run()
	//	Called by:		None
	//	Parameters:		bool on: state for the working of the calculator	
	//	Returns:		n/a 	
	//	History Log:
	//					6/3/12  PB  completed version 1.0
	//-----------------------------------------------------------------------------------------------------------------
	...
	//	File:			CRPNCalc.cpp
	//	Method:			run()
	//	Description:	Running method for calculator
	//	Programmer:		Huy Nguyen
	//	Date:			6/12/2015
	//	Version:		1.0
	//	Environment:	Hardware: Intel Xeon PC
	//					Software: Windows 7
	...
	//	Returns:		n/a 	
	//	History Log:
	//					6/9/15  HN  completed version 1.0
	//-----------------------------------------------------------------------------------------------------------------
	void CRPNCalc::run()
	{
		while(m_on)
	...
	//	Call:			run()
	//	Called by:		run()
	//	Parameters:		ostream& ostr: output stream	
	//	Returns:		n/a 	
	//	History Log:
	//					6/3/12  PB  completed version 1.0
	//					6/9/12 AT completed version 1.01
	//-----------------------------------------------------------------------------------------------------------------
